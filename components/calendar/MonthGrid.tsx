...
export function MonthGrid({ monthISO, entriesByDay, onEventClick }: { monthISO: string; entriesByDay: Record<string, CalendarEntry[]>; onEventClick?: (e: CalendarEntry) => void }) {
